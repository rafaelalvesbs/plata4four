...
textarea.addEventListener('input', function () {
    ...
    window.enviarRedacaoFinal = async () => {
        ...
        try {
            ...
            const professorId = atvDoc.exists() ? atvDoc.data().professorId : null;
            ...
            const payload = {
                ...
                titulo: propostaAtiva?.titulo || propostaAtiva?.tituloAtividade || "Redação",
            ...
            console.error(e);
            window.mostrarAviso("Atenção!", "Você só pode escrever aqui as redações que o professor enviou.", "erro"); 
        }
    };
...
.folha-caderno{height:835px;border-radius:0;width:100%;max-width:100vw;overflow:hidden;}
.linha-pautada{height:calc(835px - 35px);width:100%;}
.scroll-content{width:100%;height:100%;padding-left:55px;}
#texto-redacao{font-size:18px;padding-right:15px;overflow:hidden;}
