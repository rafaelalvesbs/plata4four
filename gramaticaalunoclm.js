...
    };
    ...
    try {
        await addDoc(collection(db, "respostas_alunos"), {
            ...
            atividadeId: String(atividadeSelecionada.id).trim(), // USAR O ID REAL
            titulo: String(atividadeSelecionada.titulo || "").trim(),
            tipo: "gramatica", 
        ...
        window.exibirAlertaMensagem("Erro", "Falha ao salvar. Tente novamente.");
    }
};
