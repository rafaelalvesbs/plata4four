window.Router.register('calendarioclm', async () => {
    ...
    const renderizarListaLateral = () => {
        ...
        container.innerHTML = exibidos.map(ev => {
            ...
            return `
                <div style="border-left: 4px solid #003058; padding: 12px; background: #f8fafc; border-radius: 12px; margin-bottom: 10px; display: flex; justify-content: space-between; align-items: center;">
                    <div>
                        <p style="font-weight: 800; font-size: 0.85rem; color: #003058; margin:0;">${ev.titulo}</p>
