...
   container.innerHTML = `
  ...
  return `
    <style>
      ...
      .card-turma-item { background: white; padding: 8px 15px; border-radius: 8px; border: 1px solid #e2e8f0; border-left: 5px solid #003058; display: flex; align-items: center; justify-content: space-between; margin-bottom: 3px; min-height: 46px; }
  ...
  100% { opacity: 1; }
    ...
    <div id="toastTurmaCriada" style="position:fixed; top:25px; right:25px; background:#003058; color:white; padding:14px 22px; border-radius:14px; font-weight:800; font-size:0.9rem; box-shadow:0 10px 20px rgba(0,0,0,0.15); opacity:0; transform:translateY(-20px); transition:transform 0.3s ease-out, opacity 0.3s; z-index:99999; pointer-events:none;">
